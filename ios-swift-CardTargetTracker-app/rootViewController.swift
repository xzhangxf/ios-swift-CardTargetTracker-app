...
class RootTabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        let home = UINavigationController(rootViewController: CardsViewController())
        home.tabBarItem = UITabBarItem(title: "Home", image: UIImage(systemName: "creditcard"), selectedImage: nil)
        ...
        self.viewControllers = [home, daily, categories, settings]
    }
}
